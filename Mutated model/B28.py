...
model = Sequential()
model.add(Conv2D(32, (3,3),strides=(4,4), input_shape=(224,224,3),padding='same', activation='relu'))
model.add(Conv2D(32, (3, 3),strides=(4,4), activation='relu',padding='same'))

model.add(MaxPooling2D(pool_size=(2, 2)))

model.add(Conv2D(64, (3,3),strides=(4,4), activation='relu',padding='same'))
model.add(Conv2D(64, (3,3),strides=(4,4), activation='relu',padding='same'))
model.add(MaxPooling2D(pool_size=(2, 2),padding='same'))

model.add(Conv2D(128, (3,3),strides=(4,4),activation='relu',padding='same'))
model.add(Conv2D(128, (3,3), strides=(4,4),activation='relu',padding='same'))
model.add(MaxPooling2D(pool_size=(2, 2),padding='same'))
